...
copy_template_gitignore() {
    log "Creating secrets directory and .gitignore..."
    ...
    log "  Copied .gitignore from template (secrets/.sops.yaml and encrypted files are generated by init_sops_and_wifi below)"
}
