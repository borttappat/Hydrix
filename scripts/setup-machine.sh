...

{
  imports = [
    ...
    ../../modules/desktop/xinitrc.nix${hw_imports}
  ];
...
main() {
    ...
    # Run all setup steps
    run_hardware_detection
    generate_machine_profile "$machine_name" "$cpu_platform" "$is_asus"
    ...
    show_completion_summary "$machine_name" "$cpu_platform" "$is_asus"
}
