# zeph - Machine-specific configuration
# Auto-generated by setup-machine.sh on Mon Dec 15 21:56:58 CET 2025
# CPU Platform: intel
# Hardware: 8086:a370 (0000:00:14.3)
#
# Architecture:
...

{
  ...
  specialisation.fallback.configuration = {
    ...
    environment.systemPackages = with pkgs; lib.mkAfter [
      (writeShellScriptBin "fallback-status" ''
        ...
        echo "  sudo nixos-rebuild boot --flake ~/Hydrix#zeph"
        echo "  sudo reboot"
      '')
    ];
  };
  ...
  specialisation.lockdown.configuration = {
    ...
    environment.systemPackages = with pkgs; lib.mkAfter [
      (writeShellScriptBin "lockdown-status" ''
        ...
        echo "NIC Passthrough: 0000:00:14.3 (8086:a370)"
        echo ""
  ...
  environment.systemPackages = with pkgs; lib.mkAfter [
    ...
    (writeShellScriptBin "vm-status" ''
      ...
      echo "  sudo nixos-rebuild boot --flake ~/Hydrix#zeph"
      echo "  sudo nixos-rebuild boot --flake ~/Hydrix#zeph --specialisation fallback"
      echo "  sudo nixos-rebuild boot --flake ~/Hydrix#zeph --specialisation lockdown"
    '')
