# Disko configuration: Full disk with LUKS encryption
# This is the recommended configuration for Hydrix
#
# Usage in install script:
#   disko --mode disko --arg device '"/dev/nvme0n1"' ./disko/full-disk-luks.nix
#
# Parameters:
...
{ device, luksName ? "cryptroot", swapSize ? "16G", ... }:
{
  disko.devices = {
    disk.main = {
      type = "disk";
      ...
      content = {
        ...
        partitions = {
          ...
          # LUKS encrypted partition with BTRFS
          luks = {
            size = "100%";
            content = {
              type = "luks";
