# zen - Machine-specific configuration
# Auto-generated by setup-machine.sh on Tue Dec 23 17:44:35 CET 2025
# CPU Platform: intel
# ASUS System: true
# Hardware: 8086:a840 (0000:00:14.3)
# User: traum
#
# Architecture:
...

{
  ...
  specialisation.fallback.configuration = {
    ...
    environment.systemPackages = with pkgs; lib.mkAfter [
      (writeShellScriptBin "fallback-status" ''
        ...
        echo "  sudo nixos-rebuild boot --flake ~/Hydrix#zen"
        echo "  sudo reboot"
      '')
    ];
  };
  ...
  environment.systemPackages = with pkgs; lib.mkAfter [
    ...
    (writeShellScriptBin "vm-status" ''
      ...
      echo "  sudo nixos-rebuild boot --flake ~/Hydrix#zen"
      echo "  sudo nixos-rebuild boot --flake ~/Hydrix#zen --specialisation fallback"
      echo "  sudo nixos-rebuild boot --flake ~/Hydrix#zen --specialisation lockdown"
    '')
